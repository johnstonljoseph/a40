...
def main() -> None:
    ...
    hold_total = cfg.blend_steps + cfg.blend_hold_steps
    total_blend_units = num_layers * hold_total
    progress = tqdm(
    ...
    try:
        blend_progress = 0
        while blend_progress <= hold_total:
            step += 1
            ...
            if advance:
                blend_progress += 1
                current_units = min(blend_progress, hold_total) * num_layers
                if rank == 0:
