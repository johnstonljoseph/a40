...
all we're changing now is the activation to what we found was learned in piecewise, and lowering kl threshold to see if it works. still blending.
if this makes enough progress, we'll move to a bigger machine with even smaller threshold. 
